...
SCANNET_RAW_PATH = Path('/home/kamnux/SpatioTemporalSegmentation/ScanNet_data/input/')
SCANNET_OUT_PATH = Path('/home/kamnux/SpatioTemporalSegmentation/ScanNet_data/output/')
TRAIN_DEST = 'train'
TEST_DEST = 'test'
...
def handle_process(path):
  ...
  print(pointcloud.shape,np.array([label[:, -1]]).T.shape )
